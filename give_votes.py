...
imgBackground=cv2.imread("evoting_background.png")
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        ts=time.time()
        data=datetime.fromtimestamp(ts).strftimer("%d-%m-%y")
    ...
    if k==ord('1'):
        ...
        if exist:
             with open("Votes"+ ".csv","+a") as csvfile:
                 ...
                 attendance = [output[0],"BJP",data,timestamp]
    ...
    if k==ord('2'):
        ...
        if exist:
             with open("Votes"+ ".csv","+a") as csvfile:
                 writer=csv.writer(csvfile)
                 attendance = [output[0],"CONGRESS",data,timestamp]
                 writer.writerow(attendance)
                 csvfile.close()
        else:
            with open("Votes"+ ".csv","+a") as csvfile:
    ...
    if k==ord('3'):
        ...
        if exist:
             with open("Votes"+ ".csv","+a") as csvfile:
                 writer=csv.writer(csvfile)
                 attendance = [output[0],"AAP",data,timestamp]
                 writer.writerow(attendance)
                 csvfile.close()
        else:
            with open("Votes"+ ".csv","+a") as csvfile:
    ...
    if k==ord('4'):
        ...
        if exist:
             with open("Votes"+ ".csv","+a") as csvfile:
                 writer=csv.writer(csvfile)
                 attendance = [output[0],"NOTA",data,timestamp]
                 writer.writerow(attendance)
                 csvfile.close()
        else:
            with open("Votes"+ ".csv","+a") as csvfile:
